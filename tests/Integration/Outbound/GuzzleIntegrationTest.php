...
it('can log outbound requests through the full stack', function () {
    ...
    $dataSanitizer = new DataSanitizer(Config::get('apilogger'));
    $logger = new OutboundApiLogger($storageManager, $dataSanitizer, Config::get('apilogger'));

    $middleware = new GuzzleLoggerMiddleware($logger);
